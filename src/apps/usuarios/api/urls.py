...
from apps.usuarios.auth_views import EstudianteRegisterView, DocenteRegisterView, InscripcionCreateView,EstudianteListView,CursoListView, GestionListView,InscripcionSerializer, LoginView
